...
class UriTemplateMicronaut implements Comparable<UriTemplateMicronaut>, UriTemplate {
     ...
     */
    protected UriTemplateMicronaut(CharSequence templateString) {
    ...
    protected UriTemplateMicronaut(CharSequence templateString, Object... parserArguments) {
     ...
     */
    protected UriTemplateMicronaut(String templateString, List<PathSegment> segments) {
     ...
     */
    public UriTemplateMicronaut nest(CharSequence uriTemplate) {
    ...
    public boolean equals(Object o) {
        ...
        UriTemplateMicronaut that = (UriTemplateMicronaut) o;
    ...
    @Override
    public int compareTo(UriTemplateMicronaut o) {
        if (this == o) {
            return 0;
        }
    ...
    /**
     * Create a new {@link UriTemplateMicronaut} for the given URI.
     *
     * @param uri The URI
     * @return The template
     */
    public static UriTemplateMicronaut of(String uri) {
        return new UriTemplateMicronaut(uri);
    }
     ...
     * @return The new URI template
     */
    protected UriTemplateMicronaut nest(CharSequence uriTemplate, Object... parserArguments) {
        if (uriTemplate == null) {
            return this;
        }
     ...
     * @return The new {@link UriTemplateMicronaut}
     */
    protected UriTemplateMicronaut newUriTemplate(CharSequence uriTemplate, List<PathSegment> newSegments) {
        return new UriTemplateMicronaut(normalizeNested(this.templateString, uriTemplate), newSegments);
    }
